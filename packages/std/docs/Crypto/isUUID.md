...
- **version** `number` _(optional)_ — Require this exact version, 1 to 8.

## Returns

`boolean` — True if the value is a UUID.

## Throws

- `RangeError` — If `version` is given and is not an integer from 1 to 8.
