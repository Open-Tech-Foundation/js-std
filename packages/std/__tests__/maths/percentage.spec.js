...
describe('Maths', () => {
  test('percentage', async () => {
    ...
    expect(percentage()).toBe(Number.NaN);
    expect(percentage(0)).toBe(Number.NaN);
    expect(percentage(undefined, 0)).toBe(Number.NaN);
    expect(percentage(0, 0)).toBe(Number.NaN);
    expect(percentage(1, 0)).toBe(Number.POSITIVE_INFINITY);
