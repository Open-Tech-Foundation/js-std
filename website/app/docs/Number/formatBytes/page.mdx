...
export const tryItCode = "console.log(formatBytes(0)); //=> '0 B'\n\nconsole.log(formatBytes(1023)); //=> '1023 B'\n\nconsole.log(formatBytes(1024)); //=> '1 KiB'\n\nconsole.log(formatBytes(1536)); //=> '1.5 KiB'\n\nconsole.log(formatBytes(0.5)); //=> '0.5 B'\n\nconsole.log(formatBytes(1234567)); //=> '1.18 MiB'\n\nconsole.log(formatBytes(1234567, { decimals: 0 })); //=> '1 MiB'\n\nconsole.log(formatBytes(-1024)); //=> '-1 KiB'\n\nconsole.log(formatBytes(1000, { binary: false })); //=> '1 KB' (using 1000)";
export const metadata = {
  title: "formatBytes — Number",
