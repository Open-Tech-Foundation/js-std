...
export const tryItCode = "console.log(formatNumber(1234567.891)); //=> '1,234,567.891'\nconsole.log(formatNumber(1234.5, { locale: 'de-DE' })); //=> '1.234,5'\nconsole.log(formatNumber(1234.5, { grouping: false })); //=> '1234.5'";
