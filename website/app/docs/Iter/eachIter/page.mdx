...
export const tryItCode = "console.log(eachIter([1, 2, 3], x => console.log(x))); //=> Logs 1, 2, 3";
export const metadata = {
  title: "eachIter — Iter",
  description: "Executes a function for each item in an iterator."
};
...
- [eachIterAsync](/docs/Iter/eachIterAsync)
