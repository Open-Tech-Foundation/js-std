...
export const tryItCode = "async function* gen() { yield 1; yield 2; }\nconsole.log(await eachIterAsync(gen(), x => console.log(x))); //=> Logs 1, 2";
export const metadata = {
  title: "eachIterAsync — Iter",
  description: "Executes a function for each item in an async iterator."
};
