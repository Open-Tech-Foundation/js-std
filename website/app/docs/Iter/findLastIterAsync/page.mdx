...
export const tryItCode = "async function* gen() { yield 1; yield 2; yield 3; }\nconsole.log(await findLastIterAsync(gen(), x => x < 3)); //=> 2";
export const metadata = {
  title: "findLastIterAsync — Iter",
  description: "Finds the last item in an async iterator that matches a predicate."
};
