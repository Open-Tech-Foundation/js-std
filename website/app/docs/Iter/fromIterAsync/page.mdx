...
export const tryItCode = "console.log(await toArrayIterAsync(fromIterAsync([1, 2, 3]))); //=> [1, 2, 3]";
export const metadata = {
  title: "fromIterAsync — Iter",
  description: "Creates an AsyncIterableIterator from an iterable, async iterable, or iterator-like object."
};
