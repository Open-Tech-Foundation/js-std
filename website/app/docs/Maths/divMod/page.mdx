...
export const tryItCode = "console.log(divMod(4, 2)); //=> [2, 0]\n\nconsole.log(divMod(11, 4)); //=> [2.75, 3]\n\nconsole.log(divMod(1, 0)); //=> [Infinity, NaN]\n\nconsole.log(divMod(0, 1)); //=> [0, 0]\n\nconsole.log(divMod(-9, -2)); //=> [4.5, -1]";
export const metadata = {
  title: "divMod — Maths",
  description: "Returns a tuple containing the quotient and the remainder of two numbers."
};
