...
export const tryItCode = "console.log(mapRange(5, [0, 10], [0, 100])); //=> 50\n\nconsole.log(mapRange(0, [0, 10], [0, 100])); //=> 0\n\nconsole.log(mapRange(10, [0, 10], [0, 100])); //=> 100\n\n// A 10-bit sensor reading byte\nconsole.log(mapRange(512, [0, 1023], [0, 255])); //=> 127.75\n\n// Celsius to Fahrenheit\nconsole.log(mapRange(50, [0, 100], [32, 212])); //=> 122";
