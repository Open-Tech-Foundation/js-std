...
export const tryItCode = "import { Decimal } from '@opentf/std';\nconsole.log(new Decimal('0.1').add('0.2').toString());\n//=> '0.3'\n\nconsole.log(new Decimal('0.3').subtract('0.1').toString());\n//=> '0.2'\n\nconsole.log(new Decimal('0.1').multiply('0.1').toString());\n//=> '0.01'\n\nconsole.log(new Decimal('0.3').divide('0.1', 10).toString());\n//=> '3'\n\nconsole.log(new Decimal('0').divide('5').toString());\n//=> '0'";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "Decimal — Maths",
  description: "Exact decimal arithmetic without floating-point errors."
};
