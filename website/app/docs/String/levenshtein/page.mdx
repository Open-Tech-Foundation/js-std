...
export const tryItCode = "console.log(levenshtein('kitten', 'sitting')); //=> 3\n\nconsole.log(levenshtein('abc', 'abc')); //=> 0\n\nconsole.log(levenshtein('', 'abc')); //=> 3\n\nconsole.log(levenshtein('cat', 'bat')); //=> 1\n\nconsole.log(levenshtein('cat', 'cart')); //=> 1\n\n// A transposition is two edits\nconsole.log(levenshtein('ab', 'ba')); //=> 2\n\n// One code point, one edit\nconsole.log(levenshtein('a😀', 'a')); //=> 1";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "levenshtein — String",
  description: "Measures the edit distance between two strings."
};
