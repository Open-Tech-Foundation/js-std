...
export const tryItCode = "console.log(stringWidth('abc')); //=> 3\nconsole.log(stringWidth('\\x1b[31mabc\\x1b[0m')); //=> 3\nconsole.log(stringWidth('🔥')); //=> 2\nconsole.log(stringWidth('こんにちは')); //=> 10";
export const metadata = {
  title: "stringWidth — String",
  description: "Calculates the visual width of a string in a terminal."
};
