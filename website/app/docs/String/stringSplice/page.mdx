...
export const tryItCode = "console.log(stringSplice('2026-07-30', 5, 2, '08')); //=> '2026-08-30'\n\nconsole.log(stringSplice('v1.4.0', 3, 1, '5')); //=> 'v1.5.0'";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "stringSplice — String",
  description: "Removes characters from a string and inserts another in their place, following Array.prototype.splice."
};
