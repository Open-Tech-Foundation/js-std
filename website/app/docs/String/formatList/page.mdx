...
export const tryItCode = "console.log(formatList(['a', 'b', 'c'])); //=> 'a, b, and c'\nconsole.log(formatList(['a', 'b'])); //=> 'a and b'\nconsole.log(formatList(['a'])); //=> 'a'\nconsole.log(formatList([])); //=> ''";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "formatList — String",
  description: "Joins a list of strings into readable prose."
};
