...
export const tryItCode = "console.log(tryParseJSON('{\"a\":1}')); //=> {a:1}\nconsole.log(tryParseJSON('[1,2,3]')); //=> [1,2,3]\nconsole.log(tryParseJSON('null')); //=> null\nconsole.log(tryParseJSON('\"hi\"')); //=> \"hi\"";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "tryParseJSON — Json",
  description: "Safely parses a JSON string without throwing. Returns a fallback instead of SyntaxError."
};
