...
export const tryItCode = "console.log(isJSONValue(null)); //=> true\nconsole.log(isJSONValue(\"hi\")); //=> true\nconsole.log(isJSONValue(0)); //=> true\nconsole.log(isJSONValue(false)); //=> true\n\nconsole.log(isJSONValue(NaN)); //=> false — would become `null`\nconsole.log(isJSONValue(Infinity)); //=> false\nconsole.log(isJSONValue(BigInt(1))); //=> false — would throw\nconsole.log(isJSONValue(undefined)); //=> false\nconsole.log(isJSONValue(() => {})); //=> false\nconsole.log(isJSONValue(Symbol(\"a\"))); //=> false";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "isJSONValue — Json",
  description: "Checks whether a value can be represented as JSON without loss."
};
