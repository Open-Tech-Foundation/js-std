...
export const tryItCode = "console.log(sort([1, 3, 2])); //=> [1, 2, 3]\n\nconsole.log(sort(['x', 'z', 'y'], 'desc')); //=> ['z', 'y', 'x']\n\nconst dates = [new Date(2023, 0, 1), new Date(2022, 0, 1)];\nconsole.log(sort(dates)); //=> [2022-01-01, 2023-01-01]";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "sort — Array",
  description: "Sorts an array of elements in ascending or descending order."
};
