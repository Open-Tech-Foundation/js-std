...
export const tryItCode = "console.log(compact([0, 1, false, 2, '', 3, null, undefined, NaN])); //=> [1, 2, 3]\n\nconsole.log(compact(['apple', '', 'Mango'])); //=> ['apple', 'Mango']\n\nconsole.log(compact([{}, []])); //=> [{}, []] (Empty objects and arrays are truthy)";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "compact — Array",
  description: "Removes all falsy values from an array."
};
