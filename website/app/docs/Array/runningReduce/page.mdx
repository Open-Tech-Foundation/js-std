...
export const tryItCode = "console.log(runningReduce([1, 2, 3, 4], (acc, cur) => acc + cur, 0)); //=> [1, 3, 6, 10]";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "runningReduce — Array",
  description: "Reduces an array, keeping every intermediate result rather than only the last one."
};
