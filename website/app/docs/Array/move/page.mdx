...
export const tryItCode = "console.log(move([1, 2, 3], 0, 2)); //=> [2, 3, 1]\n\nconsole.log(move([1, 2, 3], 0, 5)); //=> [2, 3, 1] (capped at array length)\n\nconsole.log(move([1, 2, 3], 5, 0)); //=> [1, 2, 3] (invalid source index returns original)";
