...
export const tryItCode = "console.log(removeAt([1, 2, 3], 1)); //=> [1, 3]\n\nconsole.log(removeAt([1, 2, 3, 4], 1, 2)); //=> [1, 4]\n\nconsole.log(removeAt([1, 2, 3], 0)); //=> [2, 3]";
export const metadata = {
  title: "removeAt — Array",
  description: "Removes items at the given index from the array."
};
