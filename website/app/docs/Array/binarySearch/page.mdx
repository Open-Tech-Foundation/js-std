...
export const tryItCode = "console.log(binarySearch([1, 3, 5, 7, 9], 5)); //=> 2\n\nconsole.log(binarySearch([1, 3, 5, 7, 9], 1)); //=> 0\n\nconsole.log(binarySearch([1, 3, 5, 7, 9], 4)); //=> -1\n\nconsole.log(binarySearch(['ant', 'bee', 'cow'], 'cow')); //=> 2\n\n// The first of several equal values\nconsole.log(binarySearch([1, 2, 2, 2, 3], 2)); //=> 1";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "binarySearch — Array",
  description: "Finds the index of a value in a sorted array, in O(log n) comparisons."
};
