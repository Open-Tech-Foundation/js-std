...
export const tryItCode = "console.log(bounds([])); //=> null\n\nconsole.log(bounds([1, undefined, 2, null, 3])); //=> [1, 3]\n\nconsole.log(bounds([1, 2, -3, 4, 5])); //=> [-3, 5]\n\nconsole.log(bounds(['a', 'b', 'c', 'z', 'd'])); //=> ['a', 'z']\n\nconsole.log(bounds(['apple', 'mango', 'grapes'])); //=> ['apple', 'mango']\n\nconst arr = [\n  {\n    name: 'x',\n    age: 10,\n  },\n  {\n    name: 'y',\n    age: 16,\n  },\n  {\n    name: 'z',\n    age: 13,\n  },\n  { name: 'y2', age: 16 },\n];\nconsole.log(bounds(arr, (f) => f.age));\n//=>\n// [\n//   {\n//     name: 'x',\n//     age: 10,\n//   },\n//   {\n//     name: 'y',\n//     age: 16,\n//   }\n// ]";
export const metadata = {
  title: "bounds — Array",
  description: "Returns the minimum and maximum values in an array."
};
