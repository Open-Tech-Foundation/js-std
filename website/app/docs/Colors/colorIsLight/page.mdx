...
export const tryItCode = "console.log(colorIsLight('white')); //=> true\nconsole.log(colorIsLight('black')); //=> false\nconsole.log(colorIsLight('yellow')); //=> true";
export const metadata = {
  title: "colorIsLight — Colors",
  description: "Checks if a color is light based on its relative luminance."
};
