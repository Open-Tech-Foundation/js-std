...
- 🧪 Explore standout utilities: [`Decimal`](/docs/Maths/Decimal), [`color`](/docs/Colors/color), [`uuidv7`](/docs/Crypto/uuidv7), [`formatCurrency`](/docs/Number/formatCurrency), lazy [`Iterators`](/docs/Iter/mapIter) and [set math](/docs/Maths/isSubsetOf).
