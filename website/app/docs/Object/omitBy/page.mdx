...
export const tryItCode = "const object = { a: 1, b: 'abc', c: 3 };\n\nconsole.log(omitBy(object, (v) => typeof v === 'number'));\n//=> { b: 'abc' }";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "omitBy — Object",
  description: "Creates an object composed of the object properties that do not satisfy the predicate."
};
...
<Callout type="warning" emoji="🛡️">
  `__proto__`, `constructor` and `prototype` are skipped regardless of the predicate.
</Callout>
