...
export const tryItCode = "console.log(decodeBase32('JBSWY3DP')); //=> Uint8Array [72, 101, 108, 108, 111]";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "decodeBase32 — Encoding",
  description: "Decodes a Base32 string using the standard RFC 4648 alphabet."
};
