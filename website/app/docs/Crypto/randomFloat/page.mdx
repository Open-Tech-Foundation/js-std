...
export const tryItCode = "console.log(randomFloat(0, 1)); //=> 0.7234891234567891\nconsole.log(randomFloat(1, 5)); //=> 3.456789123456789";
export const metadata = {
  title: "randomFloat — Crypto",
  description: "Generates a cryptographically strong random float within a range."
};
