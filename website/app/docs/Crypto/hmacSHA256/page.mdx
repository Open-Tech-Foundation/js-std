...
export const tryItCode = "console.log(await hmacSHA256('secret', 'hello'));\n//=> '88aab3ede8d3adf94d26ab90d3bafd4a2083070c3bcce9c014ee04a443847c0b'";
import { Callout } from "@opentf/web-docs";
export const metadata = {
  title: "hmacSHA256 — Crypto",
  description: "Computes an HMAC-SHA-256 digest of a message with a secret key."
};
